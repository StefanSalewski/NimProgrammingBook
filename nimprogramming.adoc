...
should compile your program with plain nim c first. When you have tested it well and you may need the
...
parameters in configuration files, so that we don't have to actual type then for each compiler invokation.
