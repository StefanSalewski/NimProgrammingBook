...
represented in two-complement: take binary 0, apply the two-complement operation
to get the negative of it. Note, we ignore overflow here when we add the 1! That was
easy. Can we verify that all negative numbers in two-complement can really be
...
our two-complement operation. But the only case where adding 1 changes the topmost
